...
<body>
	...
	<header class="w3-container restImg w3-center" style="padding: 80px;">
		<h1 class="w3-margin w3-jumbo storeTitle">GURUME 365</h1>
	</header>
	<!-- First Grid -->
	<div class="w3-row-padding w3-padding-32 w3-container">
		...
		<div class="w3-content">
			<div class="w3-center image">
				<a href="foodList?food='한식'">한식<img
					src="<c:url value="/resources/img/noshow.png"/>" alt="Avatar"
					height="150px"
					style="width: 30%; padding-right: 5px; padding-left: 20px;">
				</a> <a href="foodList?food='일식'">일식 <img
					src="<c:url value="/resources/img/res.png"/>" alt="Avatar"
					height="150px" style="width: 30%; padding-right: 5px;">
				</a> <a href="foodList?food='중식'">중식<img
					src="<c:url value="/resources/img/theme.png"/>" alt=""
					height="150px" style="width: 30%; padding-right: 5px;"> </a> 
				<br>
				<br>
				<br>
				<br>
				<br> 
				<a href="foodList?food='양식'">양식<img
					src="<c:url value="/resources/img/noshow.png"/>" alt="Avatar"
					height="150px"
					style="width: 30%; padding-right: 5px; padding-left: 20px;">
				</a> <a href="foodList?food='디저트'">디저트 <img
					src="<c:url value="/resources/img/res.png"/>" alt="Avatar"
					height="150px" style="width: 30%; padding-right: 5px;">
				</a> <a href="foodList?food='뷔페'">뷔페<img
					src="<c:url value="/resources/img/theme.png"/>" alt=""
					height="150px" style="width: 30%; padding-right: 5px;"> </a>
				<br>
				<br>
